...
SECRET_KEY = 'django-insecure-gc^54n50&%!o%e&*-f$$@1rag8vs%m8tiv@)0miyisu9&64#m^'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your-email@gmail.com'  # Configure this
EMAIL_HOST_PASSWORD = 'your_16_digit_app_password'  # Configure this
...
# Media files configuration (for task attachments)
MEDIA_URL = '/media/'
